...

            {
              showContact ? (
                <ul className='ml-6 my-3'>
                  <li className='hover:text-white cursor-pointer px-5 flex items-center gap-2'><Image alt='image' src='./mail-icon.svg' width={16} height={14}></Image> imrandev734@gmail.com</li>
